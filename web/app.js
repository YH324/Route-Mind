...
const I18N = {
  zh: {
    ...
    serviceKicker: "服务范围", serviceTitle: "当前在线覆盖成都武侯区与锦江区",
    serviceBody: "RouteMind 智行策当前在线体验覆盖成都武侯区、锦江区。其他城市和区县暂不支持，系统会在查询时提示。",
    serviceAccept: "我知道了",
  ...
  en: {
    ...
    serviceKicker: "Service Area", serviceTitle: "Current coverage: Wuhou and Jinjiang, Chengdu",
    serviceBody: "RouteMind 智行策 currently plans within Wuhou and Jinjiang districts in Chengdu. Other cities and districts are not supported yet.",
